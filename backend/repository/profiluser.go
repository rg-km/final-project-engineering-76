...
func (pu *ProfilUserReposistory) InsertProfilUser(profilUser ProfilUser) error {
	...
	_, err := pu.db.Exec(sqlStmt, profilUser.Name, profilUser.Email, profilUser.Gender, profilUser.Birthdate, profilUser.Address, profilUser.NoHp, profilUser.UserID)
...
func (pu *ProfilUserReposistory) UpdateProfilUser(profilUser ProfilUser) error {
	...
	_, err := pu.db.Exec(sqlStmt, profilUser.ID, profilUser.Name, profilUser.Email, profilUser.Gender, profilUser.Birthdate, profilUser.Address, profilUser.NoHp)
